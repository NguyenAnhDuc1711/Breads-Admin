...
```
Read and follow `skill/ccpm/references/{reference}.md` section `{section}` and execute ALL steps exactly as written.
...
```
Execute in order:
1. Read and follow `skill/ccpm/references/verify.md` section `epic-verify-a` — execute ALL steps
2. Read and follow `skill/ccpm/references/verify.md` section `epic-verify-b` — execute ALL steps
```
...
```
Read and follow `skill/ccpm/references/verify.md` section `epic-verify` and execute ALL steps exactly as written.
